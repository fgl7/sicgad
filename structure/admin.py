...
class EntityAdmin(admin.ModelAdmin):
    list_display = ("name", "entity_type", "category", "code", "is_active", "updated_at")
    list_filter = ("is_active", "entity_type", "category__subsector__sector")
    search_fields = (
        "name",
        "code",
        "description",
    ...
    autocomplete_fields = ("entity_type", "category")
